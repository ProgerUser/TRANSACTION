...
public class ServiceController {
	...
	private void initialize() {
		try {
			...
			{
				updateservice.setDisable(true);
				addservice.setDisable(true);
			}
	...
	private void searchService(ActionEvent actionEvent) {
		...
		TableFilter<ServiceClass> tableFilter = TableFilter.forTableView(employeeTable).apply();
	...
	private void UpdateService(ActionEvent actionEvent_) {
		if (employeeTable.getSelectionModel().getSelectedItem() == null) {
			...
			name.setLayoutX(25.0);
			name.setLayoutY(33.0);
			Label idterm = new Label("Терминал:");
			idterm.setLayoutX(69.0);
			idterm.setLayoutY(67.0);
			Label account = new Label("Транзитный счет:");
			account.setLayoutX(31.0);
			account.setLayoutY(99.0);
			Label inn = new Label("ИНН:");
			inn.setLayoutX(99);
			inn.setLayoutY(134.0);
			Label kpp = new Label("КПП:");
			kpp.setLayoutX(99.0);
			kpp.setLayoutY(167.0);
			Label acc_rec = new Label("Расчетный счет:");
			acc_rec.setLayoutX(38.0);
			acc_rec.setLayoutY(202.0);
			Label kbk = new Label("КБК:");
			kbk.setLayoutX(102.0);
			kbk.setLayoutY(233.0);
			Label okato = new Label("ОКАТО:");
			okato.setLayoutX(85.0);
			okato.setLayoutY(265.0);
			Label acc_name = new Label("Название:");
			acc_name.setLayoutX(71.0);
			acc_name.setLayoutY(303.0);
			Label bo1 = new Label("БО1:");
			bo1.setLayoutX(102.0);
			bo1.setLayoutY(335.0);
			Label bo2 = new Label("БО2:");
			bo2.setLayoutX(102.0);
			bo2.setLayoutY(364.0);
			Label comission_ = new Label("Комисиия:");
			comission_.setLayoutX(71.0);
			comission_.setLayoutY(397.0);

			TextField name_T = new TextField();
			name_T.setPrefHeight(25.0);
			name_T.setPrefWidth(331.0);
			name_T.setLayoutX(145.0);
			name_T.setLayoutY(29.0);
			name_T.setText(tr.getname());
			TextField idterm_T = new TextField();
			idterm_T.setPrefHeight(25.0);
			idterm_T.setPrefWidth(331.0);
			idterm_T.setLayoutX(145.0);
			idterm_T.setLayoutY(63.0);
			idterm_T.setText(tr.getidterm());
			TextField account_T = new TextField();
			account_T.setPrefHeight(25.0);
			account_T.setPrefWidth(331.0);
			account_T.setLayoutX(145.0);
			account_T.setLayoutY(97.0);
			account_T.setText(tr.getaccount());
			TextField inn_T = new TextField();
			inn_T.setPrefHeight(25.0);
			inn_T.setPrefWidth(331.0);
			inn_T.setLayoutX(145.0);
			inn_T.setLayoutY(131.0);
			inn_T.setText(tr.getinn());
			TextField kpp_T = new TextField();
			kpp_T.setPrefHeight(25.0);
			kpp_T.setPrefWidth(331.0);
			kpp_T.setLayoutX(145.0);
			kpp_T.setLayoutY(165.0);
			kpp_T.setText(tr.getkpp());
			TextField acc_rec_T = new TextField();
			acc_rec_T.setPrefHeight(25.0);
			acc_rec_T.setPrefWidth(331.0);
			acc_rec_T.setLayoutX(145.0);
			acc_rec_T.setLayoutY(199.0);
			acc_rec_T.setText(tr.getacc_rec());
			TextField kbk_T = new TextField();
			kbk_T.setPrefHeight(25.0);
			kbk_T.setPrefWidth(331.0);
			kbk_T.setLayoutX(145.0);
			kbk_T.setLayoutY(233.0);
			kbk_T.setText(tr.getkbk());
			TextField okato_T = new TextField();
			okato_T.setPrefHeight(25.0);
			okato_T.setPrefWidth(331.0);
			okato_T.setLayoutX(145.0);
			okato_T.setLayoutY(267.0);
			okato_T.setText(tr.getokato());
			TextField acc_name_T = new TextField();
			acc_name_T.setPrefHeight(25.0);
			acc_name_T.setPrefWidth(331.0);
			acc_name_T.setLayoutX(145.0);
			acc_name_T.setLayoutY(301.0);
			acc_name_T.setText(tr.getacc_name());
			TextField bo1_T = new TextField();
			bo1_T.setPrefHeight(25.0);
			bo1_T.setPrefWidth(331.0);
			bo1_T.setLayoutX(145.0);
			bo1_T.setLayoutY(335.0);
			bo1_T.setText(tr.getbo1());
			TextField bo2_T = new TextField();
			bo2_T.setPrefHeight(25.0);
			bo2_T.setPrefWidth(331.0);
			bo2_T.setLayoutX(145.0);
			bo2_T.setLayoutY(369.0);
			bo2_T.setText(tr.getbo2());
			TextField comission_T = new TextField();
			comission_T.setPrefHeight(25.0);
			comission_T.setPrefWidth(331.0);
			comission_T.setLayoutX(145.0);
			comission_T.setLayoutY(403.0);
